...
function test_keyaggcoeff(){
    ...
    console.log("key agg coeff 0", res.toString(16), expected.toString(16));
    
    console.log("eq:", expected==res);
    res=key_agg_coeff(pubkeys, pubkeys[1]);
    console.log("res",res);

    expected="90539EEDE565F5D054F32CC0C220126889ED1E5D193BAF15AEF344FE59D4610C";

    let aggpk=key_agg(pubkeys)[0];
    console.log("aggpk",int_from_bytes(aggpk).toString(16));
